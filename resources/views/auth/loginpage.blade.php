	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Selamat datang di UDNF elektronik</h3>
                                </div>
                            </div>
                            <div>
                                <div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" action="{{route('proseslogin')}}" method="POST">
                                        @csrf
...
<!-- feather icon js-->
<script src="{{asset('assets/js/icons/fe')}}ather-icon/feather.min.js"></script>
<script src="{{asset('assets/js/icons/fe')}}ather-icon/feather-icon.js"></script>
...
<script src="{{asset('assets/js/jsgrid/gridda')}}ta-invoice.js"></script>
<script src="{{asset('assets/js/jsgrid/jsgr')}}id-invoice.js"></script>
